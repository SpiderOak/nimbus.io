...
export SPIDEROAK_MULTI_NODE_NAME_SEQ="node-sim-00 node-sim-01 node-sim-02 node-sim-03 node-sim-04 node-sim-05 node-sim-06 node-sim-07 node-sim-08 node-sim-09"
