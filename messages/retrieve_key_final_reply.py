...
class RetrieveKeyFinalReply(object):
    """AMQP message to request retrieval of a key"""

    routing_tag = "retrieve_key_final_reply"
    ...
    def unmarshall(cls, data):
        """return a RetrieveKeyFinalReply message"""
        pos = 0
