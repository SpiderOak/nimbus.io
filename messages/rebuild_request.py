...
class RebuildRequest(object):
    """
    AMQP message to request rebuild server to rebuild an avatar
    """
    routing_key = "reconstructor.rebuild_request"
    ...
    def unmarshall(cls, data):
        """return a RebuildRequest message"""
        pos = 0
