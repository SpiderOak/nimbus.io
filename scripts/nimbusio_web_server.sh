...
export NIMBUSIO_WEB_SERVER_PIPELINE_ADDRESS="tcp://127.0.0.1:8900" 
...
export NIMBUSIO_EVENT_PUBLISHER_PULL_ADDRESS="ipc:///tmp/spideroak-event-publisher-multi-node-01/socket"
export NIMBUSIO_CENTRAL_USER_PASSWORD="1.332009188365191"
export NIMBUSIO_NODE_USER_PASSWORD="1.332009188365191"

rm "${NIMBUSIO_LOG_DIR}/diyapi_web_server.log"
python "${NIMBUSIO}/diyapi_web_server/diyapi_web_server_main.py" "$@"
